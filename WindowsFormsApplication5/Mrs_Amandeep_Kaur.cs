...
{
    public partial class Mrs_Amandeep_Kaur : Form
    {
        SqlConnection con = new SqlConnection();

        public Mrs_Amandeep_Kaur()
        {
            InitializeComponent();
        }
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from aman", con);
        ...
        private void Mrs_Amandeep_Kaur_Load(object sender, EventArgs e)
        {
