...
{
    public partial class Mr_R_S_Walia : Form
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from rs ", con);
        ...
        private void Mr_R_S_Walia_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (dataGridView1.Rows.Count > 0)
            {
                try
                {
                    ...
                    StreamWriter wr = new StreamWriter(@"E:\\Book4.xls");
